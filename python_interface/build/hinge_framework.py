...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _hinge_framework.delete_SwigPyIterator

    def value(self):
        return _hinge_framework.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _hinge_framework.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _hinge_framework.SwigPyIterator_decr(self, n)

    def distance(self, x):
        return _hinge_framework.SwigPyIterator_distance(self, x)

    def equal(self, x):
        return _hinge_framework.SwigPyIterator_equal(self, x)

    def copy(self):
        return _hinge_framework.SwigPyIterator_copy(self)

    def next(self):
        return _hinge_framework.SwigPyIterator_next(self)

    def __next__(self):
        return _hinge_framework.SwigPyIterator___next__(self)

    def previous(self):
        return _hinge_framework.SwigPyIterator_previous(self)

    def advance(self, n):
        return _hinge_framework.SwigPyIterator_advance(self, n)

    def __eq__(self, x):
        return _hinge_framework.SwigPyIterator___eq__(self, x)

    def __ne__(self, x):
        return _hinge_framework.SwigPyIterator___ne__(self, x)

    def __iadd__(self, n):
        return _hinge_framework.SwigPyIterator___iadd__(self, n)

    def __isub__(self, n):
        return _hinge_framework.SwigPyIterator___isub__(self, n)

    def __add__(self, n):
        return _hinge_framework.SwigPyIterator___add__(self, n)

    def __sub__(self, *args):
        return _hinge_framework.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _hinge_framework:
_hinge_framework.SwigPyIterator_swigregister(SwigPyIterator)
class Key(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
