...
namespace hinge_framework {
    ...
    */
    ...
    Cipher::Key Aes256Cipher::generateKey() {
        Key key;
    ...
    Cipher::Key Aes256Cipher::generateKey(const char* key_id) {
        Key key;
    ...
    Cipher::Key Aes256Cipher::readKeyFromFile(const char* key_id, const char* file_path) {
        const RsaCipher rsa;
        Key key;
